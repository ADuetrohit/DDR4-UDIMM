...
- [ ] Routing
  ...
  - [ ] Data lanes, 15 Ω → DRAM balls (TL1–TL3): byte 0 6/11 (DM0 on L1; DQ1, DQ2, DQ5, DQS0 pair via L3); DQS0 pair to be re-routed as a coupled pair (0.58 mm mismatch); length tuning after each byte is complete
