...
- [ ] Routing
  ...
  - [ ] Data lanes, 15 Ω → DRAM balls (TL1–TL3): byte 0: DM0 (L1), DQ1, DQ5, DQS0 pair (L3, coupled; halves matched to 0.001 mm, full 12.16 mm) done; DQ0, DQ2, DQ3, DQ4, DQ6, DQ7 next; length tuning after each byte is complete
